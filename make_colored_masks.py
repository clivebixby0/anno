...
for i, mask_file in enumerate(mask_files, 1):
    ...
    # Cyst (1) -> Cyan (0, 200, 255)
    # Kidney (2) -> Red (255, 0, 0)
    
    colored_mask[mask == 1] = [0, 200, 255]  # Cyst -> Cyan
    colored_mask[mask == 2] = [255, 0, 0]    # Kidney -> Red
...
print("- Cyan = Cyst (original value 1)")
print("- Red = Kidney (original value 2)")
